$(function () {
    ...
    var tKillNames = ["BetaLoader (Osiris)"];
    var ctKillNames = ["gamesense", "OneTap", "GodWare", "WeebWare", "Pandora", "FluidAim", "Baimless", "EvoWare", "Desync", "Haunted", "NetSense", "Axiss", "NMillionWare", "Kidua", "BruhWare", "MadSimple",];
